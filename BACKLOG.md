...
| F-028 | Rechazar un parte aprobado a mano, y quitar los espacios de los codigos de incidencia | 28 | spec lista | estandar | `feature/F-028-rechazo-manual` |
...
estado **spec lista** · prioridad 28 · rigor `estandar` · SDD sí · rama `feature/F-028-rechazo-manual`

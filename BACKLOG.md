...
| F-028 | Estado del parte -pendiente, aprobado, rechazado, cerrado- con historico y transicion manual | 28 | pendiente | estandar | `feature/F-028-estado-del-parte` |
...
estado **pendiente** · prioridad 28 · rigor `estandar` · SDD sí · rama `feature/F-028-estado-del-parte`

...
- [x] **TA1**: La constante del retardo en `services/postventa-front/js/config.js`
...
- [x] **TA2**: El guardado reutiliza `revalidarYGuardar` (R50), de modo que el
...
- [x] **TA3**: Los tres estados de la pantalla (guardando, guardado, no se ha
...
- [x] **TA4**: Que las correcciones **no pisan** el valor ni la confianza de la
...
- [x] **TA5**: Que la revocación de una aprobación se evalúa sobre lo guardado

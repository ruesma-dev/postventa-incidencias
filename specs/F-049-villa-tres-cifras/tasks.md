...
- [ ] T2: RED — `tests/test_f049_villa_tres_cifras.py` con R1–R4, en rojo por
...
- [ ] T3: `nombre_derivado_de_unidad` con `:03d` y la cascada de tests de
...
- [ ] T4: recuadros fechados en `specs/F-013-archivo-posventa/`
